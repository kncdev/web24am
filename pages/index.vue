<template>
    ...
    <div class="w-full lg:max-w-[90rem] mx-auto">
      <div class="lg:relative lg:overflow-hidden bg-[#fff] lg:ps-[5.75rem]">
        ...
        <div class="hero-wrapper flex flex-col">
          <div class="hero-content-start hero-title-desktop lg:block hidden lg:w-[27.063rem] bg-white lg:fixed lg:top-0 lg:left-0 lg:bottom-0 lg:z-10 lg:h-screen">
